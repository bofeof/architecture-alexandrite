...
| Number of HTTP 200 / 500 | path, method / endpoint, system (shop / CRM / MES), user_id | Количество успешных (20*) и ошибочных (50*) ответов. Позволяет контролировать корректность работы API |
